...
#################################################################################################
  ...
  print("Tempo total de simulação %d: %f" % (k+1, time.time() - start_loop))
  L1_soma += L1
  L2_soma += L2
  L3_soma += L3
...
L1, L2, L3 = lib_MC.counting_sort(L1_soma, int(max(L1_soma))), lib_MC.counting_sort(
...
filename = 'results-%d.txt' %n_loops
